...
-- 3. Add strand_track_id to enrollments
ALTER TABLE enrollments
  ADD COLUMN strand_track_id INT NULL AFTER program,
  ADD FOREIGN KEY (strand_track_id) REFERENCES strand_tracks(id);

-- 4. Seed default strand tracks

-- TLE specializations (Grades 7-10)
INSERT INTO strand_tracks (code, name, track_type, grade_level, description, sort_order) VALUES
