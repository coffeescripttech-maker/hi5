...
export const GUIDE_META = {
  ...
  footer: "Don Servillano Platon Memorial National High School · Sta. Cruz, Tinambac, Camarines Sur",
};
...
export const roles: GuideRole[] = [
  {
    role: "Administrator",
    summary:
      "Sets up the system for the whole school: the school year, subjects, sections, and the accounts teachers and the registrar use.",
    duties: [
      "Create and manage school years (e.g. 2026–2027) and mark which one is active.",
      "Create the list of subjects and the section types available for each grade level.",
      "Create teacher, registrar, and principal accounts so each person can sign in.",
      "Configure school settings — school name, IDs, principal and registrar names, grade-edit deadlines, backups.",
      "Oversee role access — which modules each role can open.",
    ],
    pages: ["School Year Mgmt", "Subjects", "Sections & Types", "User Management", "System Settings"],
  },
  {
    role: "Teacher",
    summary:
      "Handles the day-to-day classroom data: enrolling students, encoding their grades, locking grades, and printing school forms.",
    duties: [
      "Enroll new Grade 7 students, returning students (G8–G12), and Balik-Aral students.",
      "Encode quarterly grades (Q1–Q4) for students in your sections and subjects.",
      "Lock grades when encoding is finished for a quarter or subject.",
      "Generate and print school forms (SF1, SF5, SF9, SF10).",
      "Run bulk promotion at the end of the year, or mark Grade 12 students as completers.",
    ],
    pages: ["Enrollment", "My Sections", "Grade Management", "Upload Grades", "School Forms", "Student List"],
  },
  {
    role: "Registrar",
    summary:
      "Controls sectioning and records: assigns newly enrolled students to sections, monitors enrollment, and produces official reports and certificates.",
    duties: [
      "Assign unassigned (pending) students to sections — manually, randomly, by placement exam, or by strand carryover.",
      "Monitor the enrollment report and check for at-risk students.",
      "Generate certificates (Enrollment, Good Moral) and run enrollment reports.",
      "Advance the system to the next school year at the end of the cycle.",
    ],
    pages: ["Section Assignment", "Enrollment Report", "Certificates", "At-Risk Students", "Document Completion"],
  },
  {
    role: "Principal / School Head",
    summary:
      "Views the school-wide picture — enrollment numbers, grade progress, and promotion statistics — without changing data.",
    duties: [
      "Review enrollment figures per grade level and by gender.",
      "Monitor grade submittal progress across sections and teachers.",
      "Check promotion and retention statistics at year end.",
    ],
    pages: ["Principal Dashboard", "Enrollment Figures", "Grade Progress", "Promotion Stats"],
  },
];
...
export const howtos: GuideHowTo[] = [
  ...
  },
  {
    ...
    summary: "For a student continuing from last year, or returning after being out of school.",
    steps: [
  ...
  {
    title: "Lock Grades",
    summary: "Seal a finished grading period so grades cannot be silently changed.",
    steps: [
  ...
  },
  {
    ...
    summary: "Official documents for students leaving or needing proof of enrollment.",
    steps: [
...
export const glossary: GlossaryEntry[] = [
  ...
  {
    term: "SF1",
    definition: "School Form 1 — the class/shool register of enrolled learners for a section.",
  },
  {
    term: "SF5",
    definition: "School Form 5 — the report on promotion and level of proficiency by subject.",
  },
  {
    term: "SF9",
    definition: "School Form 9 — the learner's report card (Progress Report Card).",
  },
  {
    term: "SF10",
