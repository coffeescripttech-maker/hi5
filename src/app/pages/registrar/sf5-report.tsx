...
const LEAF_COLUMNS: Leaf[] = [
  { key: 'lrn', width: '6%' },
  { key: 'name', width: '24%' },
  { key: 'average', width: '10%' },
  { key: 'action', width: '14%' },
  { key: 'incomplete_completed', width: '23%' },
  { key: 'incomplete_current', width: '23%' }
];
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-lg font-bold text-gray-900 tracking-[-0.02em]">
                  School Form 5 (SF5) Report on Promotion &amp; Level of
