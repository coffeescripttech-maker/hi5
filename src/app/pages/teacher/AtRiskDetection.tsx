    ...
    <div className="space-y-5 max-w-6xl mx-auto">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        ...
        <div className="p-5 sm:p-6 flex items-center gap-4">
          ...
          <div className="hidden sm:flex items-center gap-2 text-xs text-gray-400 bg-violet-50/80 px-3.5 py-2 rounded-xl border border-violet-100">
            <Zap size={13} className="text-violet-500" />
            <span className="font-semibold text-violet-700">Live</span>
      ...
      {/* ── Info ── */}
      <div className="bg-violet-50/60 border border-violet-100 rounded-2xl px-5 py-4 flex gap-3">
